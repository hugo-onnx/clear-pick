  ...
  (
    ...
    const backdropFilter =
      displacementScale > 0
        ...
        : "blur(10px) saturate(155%)";
    const buttonStyle = {
      ...style,
      "--liquid-glass-color": glassColor || "oklch(from var(--foreground) l c h / 5%)",
      "--liquid-glass-backdrop-filter": backdropFilter,
    } as React.CSSProperties & {
      "--liquid-glass-color": string;
      "--liquid-glass-backdrop-filter": string;
    };
    ...
    return (
      <>
        ...
        <style>{`
          ...
          .btn-liquid-lens {
            background-color: var(--liquid-glass-color);
